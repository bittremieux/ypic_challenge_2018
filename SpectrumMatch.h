...
namespace spectral_network
{
    ...
    class SpectrumSpectrumMatch
    {
        public:
            SpectrumSpectrumMatch() :
                m_score(0), m_peak_matches(new std::vector<std::pair<unsigned int, unsigned int>>()) {}
    ...
    class SpectrumMatcher
    {
        public:
            ...
            SpectrumSpectrumMatch* dot(Spectrum *query, Spectrum *candidate, double fragment_mz_tolerance, bool allow_shift);
    };
}
